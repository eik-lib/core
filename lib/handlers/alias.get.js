...
const handler = async (sink, req, org, name, alias, extra) => {
    ...
    const path = Alias.buildPath(org, name, alias);
    ...
    const location = Alias.buildPathname(obj.org, obj.name, obj.version, extra);
