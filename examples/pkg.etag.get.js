...
const get = async () => {
    ...
    const resA = await fetch('http://localhost:4001/pkg/fuzz/8.4.1/main/index.js', {
        method: 'GET',
    });
    ...
    const resB = await fetch('http://localhost:4001/pkg/fuzz/8.4.1/main/index.js', {
        method: 'GET',
        headers: {
    ...
    const resC = await fetch('http://localhost:4001/pkg/fuzz/8.4.1/main/index.js', {
        method: 'GET',
        headers: {
