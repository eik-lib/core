...
exports[`test/integration/map.js TAP import-map - put map -> get map - non scoped successfully uploaded > on GET of map, response should match snapshot 1`] = `
Object {
  "imports": Object {
...
exports[`test/integration/map.js TAP import-map - put map -> get map - scoped successfully uploaded > on GET of map, response should match snapshot 1`] = `
Object {
  "imports": Object {
    "fuzz": "http://localhost:4001/finn/pkg/fuzz/v8",
  },
