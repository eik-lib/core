...
test('alias map - put alias, then get map through alias - scoped', async (t) => {
    ...
    t.equals(uploaded.headers.get('location'), `${address}/biz/map/@cuz/fuzz/8.4.1`, 'on PUT of map, server should respond with a location header');
    ...
    t.equals(alias.headers.get('location'), `${address}/biz/map/@cuz/fuzz/v8`, 'on PUT of alias, server should respond with a location header');
    ...
    t.equals(redirect.headers.get('location'), `${address}/biz/map/@cuz/fuzz/8.4.1`, 'on GET of map through alias, server should respond with a location header');
...
test('alias map - put alias, then get map through alias - non scoped', async (t) => {
    ...
    t.equals(uploaded.status, 303, 'on PUT of map, server should respond with a 303 redirect');
    t.equals(uploaded.headers.get('location'), `${address}/biz/map/fuzz/8.4.1`, 'on PUT of map, server should respond with a location header');
    ...
    t.equals(alias.status, 303, 'on PUT of alias, server should respond with a 303 redirect');
    t.equals(alias.headers.get('location'), `${address}/biz/map/fuzz/v8`, 'on PUT of alias, server should respond with a location header');
    ...
    t.equals(redirect.status, 303, 'on GET of map through alias, server should respond with a 303 redirect');
    t.equals(redirect.headers.get('location'), `${address}/biz/map/fuzz/8.4.1`, 'on GET of map through alias, server should respond with a location header');
...
test('alias map - put alias, then delete alias, then get map through alias - scoped', async (t) => {
    ...
    // GET map through alias from server
    const errored = await fetch(`${address}/biz/map/@cuz/fuzz/v8`, {
        method: 'GET',
        redirect: 'manual',
    });
...
test('alias map - put alias, then delete alias, then get map through alias - non scoped', async (t) => {
    ...
    // GET map through alias from server
    const errored = await fetch(`${address}/biz/map/fuzz/v8`, {
        method: 'GET',
        redirect: 'manual',
    });
